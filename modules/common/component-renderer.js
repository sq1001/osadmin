layui.define(['jquery'], function(exports) {
  ...
  var componentRenderer = {
    ...
    clearCache: function(container) {
      ...
      var $pageContent = $container.is('.page-content') ? $container : $container.find('.page-content');
      if ($pageContent.length > 0) {
        $pageContent.removeData('form-rendered element-rendered');
      }
