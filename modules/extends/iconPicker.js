 ...
 * 
 * 功能说明：
 * - 提供图标选择器功能，支持 Layui 图标库
 * - 支持 fontClass 和 unicode 两种模式
 * - 支持分页、搜索、自定义配置
 */
layui.define(['laypage', 'form'], function(exports) {
	"use strict";

	var MOD_NAME = 'iconPickerMod';
	var	$ = layui.jquery,
	...
	IconPicker.prototype.render = function(options) {
		...
		var a = {
			...
			createList: function(text) {
				var d = data,
					l = d.length,
					pageHtml = '',
					listHtml = $('<div class="layui-iconpicker-list">');
		...
		var common = {
			loadCss: function() {
				var css =
					'.layui-iconpicker {min-width: 280px;}.layui-iconpicker .layui-anim{display:none;position:absolute;left:0;top:42px;padding:5px 0;z-index:899;min-width:100%;border:1px solid #d2d2d2;max-height:300px;overflow-y:auto;background-color:#fff;border-radius:2px;box-shadow:0 2px 4px rgba(0,0,0,.12);box-sizing:border-box;}.layui-iconpicker-item{border:1px solid #e6e6e6;width:90px;height:38px;border-radius:4px;cursor:pointer;position:relative;}.layui-iconpicker-icon{border-right:1px solid #e6e6e6;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;width:60px;height:100%;float:left;text-align:center;background:#fff;transition:all .3s;}.layui-iconpicker-icon i{line-height:38px;font-size:18px;}.layui-iconpicker-item > .layui-edge{left:70px;}.layui-iconpicker-item:hover{border-color:#D2D2D2!important;}.layui-iconpicker-item:hover .layui-iconpicker-icon{border-color:#D2D2D2!important;}.layui-iconpicker.layui-form-selected .layui-anim{display:block;}.layui-iconpicker-body{padding:6px;}.layui-iconpicker .layui-iconpicker-list{background-color:#fff;border:1px solid #ccc;border-radius:4px;}.layui-iconpicker .layui-iconpicker-icon-item{display:inline-block;width:21.9%;line-height:36px;text-align:center;cursor:pointer;vertical-align:top;height:36px;margin:4px;border:1px solid #ddd;border-radius:2px;transition:300ms;}.layui-iconpicker .layui-iconpicker-icon-item i.layui-icon{font-size:17px;}.layui-iconpicker .layui-iconpicker-icon-item:hover{background-color:#eee;border-color:#ccc;-webkit-box-shadow:0 0 2px #aaa,0 0 2px #fff inset;-moz-box-shadow:0 0 2px #aaa,0 0 2px #fff inset;box-shadow:0 0 2px #aaa,0 0 2px #fff inset;text-shadow:0 0 1px #fff;}.layui-iconpicker-search{position:relative;margin:0 0 6px 0;border:1px solid #e6e6e6;border-radius:2px;transition:300ms;}.layui-iconpicker-search:hover{border-color:#D2D2D2!important;}.layui-iconpicker-search .layui-input{cursor:text;display:inline-block;width:86%;height: 36px;border:none;padding-right:0;margin-top:0;margin-bottom:0;}.layui-iconpicker-search .layui-icon{position:absolute;right:8px;top:50%;margin-top:-10px;color:#999;}.layui-iconpicker-page{position:relative;padding:8px 0 0 0;border-top:1px solid #e6e6e6;}.layui-iconpicker-page-count{display:inline-block;margin-left:10px;}.layui-iconpicker-page-operate{position:absolute;right:10px;top:7px;}.layui-iconpicker-page-operate .layui-icon{cursor:pointer;}.layui-iconpicker-page-operate .layui-icon:hover{color:#01AAED;}.layui-iconpicker-body-page .layui-iconpicker-list{margin-bottom:0px;}.layui-iconpicker-tips{text-align:center;color:#999;padding:10px 0;}.layui-iconpicker-icon-limit{display:none;}.layui-iconpicker-icon-limit:first-child{display:block;}';
